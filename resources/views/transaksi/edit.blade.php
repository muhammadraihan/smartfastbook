...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$transaksi->customer}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['transaksi.update',$transaksi->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-3 mb-3">
                        {{ Form::label('customer','Nama Customer',['class' => 'required form-label'])}}
                        {{ Form::text('customer',$transaksi->customer,['placeholder' => 'Name Customer','class' => 'form-control '.($errors->has('customer') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-3 mb-3">
                        ...
                        {!! Form::select('bank_tujuan', $tujuan, $transaksi->bank_tujuan, ['id' =>
                        'tujuan','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('no_rek',$transaksi->no_rek,['placeholder' => 'No Rekening', 'id' => 'norek', 'name' => 'norek', 'class' => 'norek form-control '.($errors->has('no_rek') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('nama_rekening',$transaksi->nama_rekening,['placeholder' => 'Nama Rekening', 'id' => 'nama', 'name' => 'nama', 'class' => 'form-control '.($errors->has('nama_rekening') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'readonly'])}}
                    ...
                    <div class="form-group col-md-3 mb-3">
                        ...
                        {!! Form::select('bank_uuid', $bank, $transaksi->bank_uuid, ['id' =>
                        'bank','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('biaya_admin',$transaksi->biaya_admin,['placeholder' => '','class' => 'form-control '.($errors->has('biaya_admin') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'data-inputmask' => "'alias': 'currency','prefix': ''"])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('admin_bank',$transaksi->admin_bank,['placeholder' => '','class' => 'form-control '.($errors->has('admin_bank') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'data-inputmask' => "'alias': 'currency','prefix': ''"])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('nominal',$transaksi->nominal,['placeholder' => '','class' => 'form-control '.($errors->has('nominal') ? 'is-invalid':''),'required', 'autocomplete' => 'off', 'data-inputmask' => "'alias': 'currency','prefix': ''"])}}
                    ...
                    <div class="form-group col-md-3 mb-3">
                        ...
                        {{ Form::text('keterangan',$transaksi->keterangan,['placeholder' => 'Keterangan','class' => 'form-control '.($errors->has('keterangan') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
