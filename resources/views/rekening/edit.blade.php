...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$rekening->nama}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['rekening.update',$rekening->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-3 mb-3">
                        {{ Form::label('bank_uuid','Nama Bank',['class' => 'required form-label'])}}
                        {!! Form::select('bank_uuid', $bank, $rekening->bank_uuid, ['id' =>
                        'bank','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('no_rekening', $rekening->no_rekening,['placeholder' => 'No Rekening', 'class' => 'norek form-control '.($errors->has('no_rekening') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('nama', $rekening->nama,['placeholder' => 'Nama Rekening', 'class' => 'form-control '.($errors->has('nama') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('nama'))
