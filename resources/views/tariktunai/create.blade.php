...
@section('title', 'Tarik Tunai Create')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Tarik Tunai </i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'tariktunai.store','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-3 mb-3">
                        ...
                        {{ Form::text('no_kartu',null,['placeholder' => 'No Kartu','class' => 'form-control '.($errors->has('no_kartu') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
